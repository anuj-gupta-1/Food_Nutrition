#!/usr/bin/env python3
"""
Display V2 classification results
"""

import sys
import os
sys.path.append(os.path.join(os.path.dirname(__file__)))
from product_classification_v2 import run_trial_v2
...
if __name__ == "__main__":
    # Run trial classification V2 on products 22-32
    results_df, high_conf, medium_conf, low_conf = run_trial_v2(
        start_idx=22,
        end_idx=32,
        use_llm=False  # Test rules first
    )
